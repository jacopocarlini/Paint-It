Player = function(data) {
    ...
    var playermesh = new Physijs.CapsuleMesh(
    ...
    this.update = function(data) {
        if (p1) {
            ...
            var oldVector = playermesh.getLinearVelocity(); // Vector of velocity the player already has
            var playerVec3 = new THREE.Vector3(oldVector.x + .5 * this.xvelocity, oldVector.y, oldVector.z);
            playermesh.setLinearVelocity(playerVec3); // We use an updated vector to redefine its velocity
